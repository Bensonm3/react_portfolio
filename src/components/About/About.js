        ...
        <div class="row">
            <div class="row row3">
                ...
                <div class="col-md-12 contentbox">
                    <img class="matt" src={Matt} alt="Matt gets Married" />
                    
                    <div class = "headerBox">
                    <br /><br />
                        <p class= "header">Full Stack Web Developer & Supply Chain Expert based in Seattle, WA</p>
                ...
                <div class="row row4">
                    ...
                    <div class="col-md-8 d-flex justify-content-center">
                        ...
                        <br /><br />Like every millenial, I also enjoy traveling in my spare time and will be planning my next international trip as soon as life gets back to “normal”. My most recent trips were to Costa Rica, and a lovely Honeymoon with my wonderful wife.
                            ...
                            <div class ="row">
                                ...
                                <div class="col-md-6 carouselContainer">
                                    <div class="carousel">
                                        <Carousel>
                                            <div>
                                                <img src="https://raw.githubusercontent.com/Bensonm3/Portfolio-Photos/master/wedding.jpg"/>
                                                <p className="legend">Kim and I got married!</p>
                                            </div>
                                            <div>
                                                <img src="https://raw.githubusercontent.com/Bensonm3/Portfolio-Photos/master/Norway.PNG"/>
                                                <p className="legend">Trail race in Norway!</p>
                                            </div>
                                            <div>
                                                <img src="https://raw.githubusercontent.com/Bensonm3/Portfolio-Photos/master/Porter.jpeg"/>
                                                <p className="legend">My dog Porter loves to hike!</p>
                                            </div>
                                            <div>
